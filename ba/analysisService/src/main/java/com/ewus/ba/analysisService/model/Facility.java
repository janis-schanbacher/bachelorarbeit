...
//     private String nighttimeFrom; // Einsparzaehlerprotokoll> 040 Nachtabsenkung Start; z.b.
// "01:30",
...
public class Facility {
  ...
  private int nachtabsenkungAbfrageintervall; // Einsparzaehlerprotokoll > 200
  // Nachtabsenkung Abfrageintervall (Tage)

  private int nachtabsenkungAbfragezeitraum; // Einsparzaehlerprotokoll > 201
  // Nachtabsenkung Abfragezeitraum (Tage)
  ...
  private String aussentemperaturId; // Eneffco Datenpunkt Tabelle:
  ...
  private String nighttimeFrom; // Einsparzaehlerprotokoll> 040 Nachtabsenkung Start;
  // z.b. "01:30",

  private String nighttimeTo; // Einsparzaehlerprotokoll> 041 Nachtabsenkung Ende; z.b.
  // "02:30"

  // results
  private String absenkungWeekStart; // Einsparzaehlerprotokoll> 040 Nachtabsenkung
  // Start

  private String absenkungWeekEnd; // Einsparzaehlerprotokoll> 041 Nachtabsenkung Ende

  private String absenkungWeekendStart; // Einsparzaehlerprotokoll> 042 Nachtabsenkung
  // WE Start

  private String absenkungWeekendEnd; // Einsparzaehlerprotokoll> 043 Nachtabsenkung WE
  // Ende

  private String pAbsenkungMoDiMiDo; // Einsparzaehlerprotokoll> 311 Nachtabsenkung
  // Wahrsch. Mo-Do

  private String pAbsenkungFr; // Einsparzaehlerprotokoll> 311 Nachtabsenkung Wahrsch.
  // Fr

  private String pAbsenkungSa; // Einsparzaehlerprotokoll> 312 Nachtabsenkung Wahrsch.
  // Sa

  private String pAbsenkungSo; // Einsparzaehlerprotokoll> 313 Nachtabsenkung Wahrsch.
  // So

  int[] predictionsUmstellung; // in Rohdatenpunkt ACO.001.WEZ.MON.1 in Eneffco
  // schreiben
  ...
  private String yAchsenabschnitt; // Einsparzaehlerprotokoll> 300 Heizkurve
  // y-Achsenabschnitt

  private String steigung; // Einsparzaehlerprotokoll> 301 Heizkurve Steigung

  private String minimumAussentemp; // Einsparzaehlerprotokoll> 302 Heizkurve
  // minimumAussentemp

  private String textFragments; // Einsparzaehlerprotokoll > Regelparameter_Soll-Werte >
  // 960 AKTUELL
  ...
  public String getTextFragmentsPrev() {
    return textFragmentsPrev;
  }

  public void setTextFragmentsPrev(String textFragmentsPrev) {
  ...
  public String toString() {
    ...
    str.append(
        "nachtabsenkungAbfragezeitraum: "
            + nachtabsenkungAbfragezeitraum
            + "\n"); // Einsparzaehlerprotokoll
    // >
    // 201
    // Abfrage-Parameter from und to ...
    str.append("wmzEneffco: " + wmzEneffco + "\n"); // Einsparzaehlerprotokoll> 190
    // WMZ Eneffco (letzte Stelle im
    // DP
    // Code)
    // vorlaufId, aussentemperatur, volumenstromId and leistungId are eneffco object
    // ids
    ...
    // Start; z.b.
    // "01:30",
    str.append("nighttimeTo: " + nighttimeTo + "\n"); // Einsparzaehlerprotokoll> 041
    // Nachtabsenkung Ende; z.b.
    // "02:30"
    // results
    ...
    // Ende
    str.append(
        "absenkungWeekendStart: " + absenkungWeekendStart + "\n"); // Einsparzaehlerprotokoll>
    // 042
    // Nachtabsenkung
    // WE
    // Start
    ...
    // 311 Nachtabsenkung Wahrsch.
    // Fr
    str.append("pAbsenkungSa: " + pAbsenkungSa + "\n"); // Einsparzaehlerprotokoll>
    // 312 Nachtabsenkung Wahrsch.
    // Sa
    str.append("pAbsenkungSo: " + pAbsenkungSo + "\n"); // Einsparzaehlerprotokoll>
    // 313 Nachtabsenkung Wahrsch.
    // So
    int[] predictionsUmstellung; // in Rohdatenpunkt ACO.001.WEZ.MON.1 in Eneffco
    // schreiben
    str.append("heizgrenze: " + heizgrenze + "\n"); // Einsparzaehlerprotokoll> 050
    // Heizgrenze
    ...
    str.append(
        "textFragments: "
            + textFragments
            + "\n"); // Einsparzaehlerprotokoll>Regelparameter_Sollwerte
    // 960
    // AKTUELL Textbausteine
    // Auto Analyse
    str.append(
        "textFragmentsPrev: "
            + textFragmentsPrev
    ...
    str.append(
        "nachtabsenkungAbfrageintervall: "
            + nachtabsenkungAbfrageintervall
            + "\n"); // Einsparzaehlerprotokoll
    // >
    // 200
