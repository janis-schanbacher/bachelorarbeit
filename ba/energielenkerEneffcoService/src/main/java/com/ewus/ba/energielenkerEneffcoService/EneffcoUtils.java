...
public class EneffcoUtils {
    ...
    public static void fetchEneffcoIds(Connection c, Facility facility) {
        ...
        try {
            facility.setVorlauf(getEneffcoId(c, facility.getCode() + ".WEZ.WMZ.VL." + facility.getWmzEneffco()));
            facility.setRuecklauf(getEneffcoId(c, facility.getCode() + ".WEZ.WMZ.RL." + facility.getWmzEneffco()));
            facility.setVolumenstrom(getEneffcoId(c, facility.getCode() + ".WEZ.WMZ.VS." + facility.getWmzEneffco()));
            facility.setLeistung(getEneffcoId(c, facility.getCode() + ".WEZ.WMZ.L." + facility.getWmzEneffco()));
            // System.out.println("Getting aussentemperatur based on code: " +
            // facility.getAussentemperaturCode() + "...\n");
            facility.setAussentemperatur(getEneffcoId(c, facility.getAussentemperaturCode()));
            System.out.println("## Eneffco ids: " + facility.getCode());
            System.out.println("Vorlauf: " + facility.getVorlauf());
            System.out.println("Ruecklauf: " + facility.getRuecklauf());
            System.out.println("Volumenstrom: " + facility.getVolumenstrom());
            System.out.println("Leistung: " + facility.getLeistung());
            System.out.println("Aussentemperatur: " + facility.getAussentemperatur());
        } catch (Exception e) {
